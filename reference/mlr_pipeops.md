...
[`PipeOp`](https://mlr3pipelines.mlr-org.com/reference/PipeOp.md). Each
[`PipeOp`](https://mlr3pipelines.mlr-org.com/reference/PipeOp.md) has an
associated help page, see `mlr_pipeops_[id]`.
