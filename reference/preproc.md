...
[`Graph`](https://mlr3pipelines.mlr-org.com/reference/Graph.md)s on
...
- processor:
  ...
  [`po()`](https://mlr3pipelines.mlr-org.com/reference/po.md) or
...
S3 method `preproc.PipeOp` gets called first, converting the `PipeOp`
into a [`Graph`](https://mlr3pipelines.mlr-org.com/reference/Graph.md)
and wrapping the `state` appropriately, before calling the S3 method
