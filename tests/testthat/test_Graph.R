...
test_that("assert_graph test", {
  ...
  expect_error(expect_deep_clone(gr, gr2), class = "error", "addresses differ.*is not TRUE")
  ...
  expect_error(expect_deep_clone(po, po), class = "error", "addresses differ.*is not TRUE")
