...
test_that("base_learner() works", {
  ...
  expect_identical(x$base_learner(-1), x)
  expect_identical(x$base_learner(0), x$base_learner())
  ...
  expect_learner(x$base_learner())
  expect_identical(x$base_learner(-1), x)
  expect_identical(x$base_learner(0), x$graph_model$pipeops$scale.classif.rpart$learner_model)
