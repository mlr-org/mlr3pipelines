...
object, a representation of a computational graph. It can have multiple
**input channels**—think of these as multiple arguments to a function,
for example when averaging different models—, and multiple **output
...
the [`Graph`](https://mlr3pipelines.mlr-org.com/dev/reference/Graph.md)
is to connect different outputs of some `PipeOp`s to inputs of other
`PipeOp`s.
...
[`Graph`](https://mlr3pipelines.mlr-org.com/dev/reference/Graph.md)
should inherit from, and is not intended to be instantiated.
...
- `id` :: `character`  
  ...
  [`Graph`](https://mlr3pipelines.mlr-org.com/dev/reference/Graph.md).
  IDs of `PipeOp`s must not be changed once they are part of a
  [`Graph`](https://mlr3pipelines.mlr-org.com/dev/reference/Graph.md),
  instead the
  [`Graph`](https://mlr3pipelines.mlr-org.com/dev/reference/Graph.md)'s
...
- `tags` ::`character`  
  ...
  [`as.data.table(mlr_pipeops)`](https://mlr3pipelines.mlr-org.com/dev/reference/mlr_pipeops.md).
...
- `properties` ::
  ...
  - `"validation"`: the `PipeOp` can make use of the
    ...
    [`PipeOpLearner`](https://mlr3pipelines.mlr-org.com/dev/reference/mlr_pipeops_learner.md)s
    that wrap a
