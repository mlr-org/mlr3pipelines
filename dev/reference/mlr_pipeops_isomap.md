...
Reduces the dimensionality of the data of the input
[`Task`](https://mlr3.mlr-org.com/reference/Task.html) using the Isomap
algorithm from the `dimRed`-package, preserving geodesic distances
...
[`Task`](https://mlr3.mlr-org.com/reference/Task.html) with the data
projected to the lower-dimensional space.
...
- `embed_result` :: `dimRedResult`  
  The resulting object after applying the "Isomap"-method from the
  `dimRed`-package to the data.
...
- `.mute` :: `character`  
  A character vector of elements to mute during training (e.g.
  c("message", "output")). Initialized to `NULL`.
...
#> 2025-11-30 16:57:09.202129: Isomap START
#> 2025-11-30 16:57:09.202684: constructing knn graph
#> 2025-11-30 16:57:09.208479: calculating geodesic distances
#> 2025-11-30 16:57:09.220284: Classical Scaling
#>        Species     iso 1       iso 2
#>         <fctr>     <num>       <num>
...
#> 2025-11-30 16:57:09.241616: L-Isomap embed START
#> 2025-11-30 16:57:09.242047: constructing knn graph
#> 2025-11-30 16:57:09.303617: calculating geodesic distances
#> 2025-11-30 16:57:09.332577: embedding
#> 2025-11-30 16:57:09.333416: DONE
#>        Species     iso 1       iso 2
#>         <fctr>     <num>       <num>
