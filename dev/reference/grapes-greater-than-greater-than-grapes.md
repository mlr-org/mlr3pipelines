...
(or an object that can be automatically converted into a
...
after composition, use the resulting
...
then this
[`Graph`](https://mlr3pipelines.mlr-org.com/dev/reference/Graph.md) will
...
[`PipeOp`](https://mlr3pipelines.mlr-org.com/dev/reference/PipeOp.md)s
(such as [`Learner`](https://mlr3.mlr-org.com/reference/Learner.html)s
or [`Filter`](https://mlr3filters.mlr-org.com/reference/Filter.html)s),
or that can be converted to
[`Graph`](https://mlr3pipelines.mlr-org.com/dev/reference/Graph.md)s.
This means, in particular, `list`s of
[`Graph`](https://mlr3pipelines.mlr-org.com/dev/reference/Graph.md)s,
[`PipeOp`](https://mlr3pipelines.mlr-org.com/dev/reference/PipeOp.md)s
or objects convertible to that, because
[`as_graph()`](https://mlr3pipelines.mlr-org.com/dev/reference/as_graph.md)
automatically applies
[`gunion()`](https://mlr3pipelines.mlr-org.com/dev/reference/gunion.md)
to `list`s. See examples. If the first argument of `%>>!%` is not a
[`Graph`](https://mlr3pipelines.mlr-org.com/dev/reference/Graph.md),
then it is cloned just as when `%>>%` is used; `%>>!%` only avoids
`clone()` if the first argument is a
[`Graph`](https://mlr3pipelines.mlr-org.com/dev/reference/Graph.md).

Note that if `g1` is `NULL`, `g2` converted to a
[`Graph`](https://mlr3pipelines.mlr-org.com/dev/reference/Graph.md) will
be returned. Analogously, if `g2` is `NULL`, `g1` converted to a
[`Graph`](https://mlr3pipelines.mlr-org.com/dev/reference/Graph.md) will
be returned.
...
- g1:
  ...
  [`PipeOp`](https://mlr3pipelines.mlr-org.com/dev/reference/PipeOp.md)
  /
  object-convertible-to-[`PipeOp`](https://mlr3pipelines.mlr-org.com/dev/reference/PipeOp.md)
