...
Renames the columns of a
[`Task`](https://mlr3.mlr-org.com/reference/Task.html) both during
training and prediction. Uses the `$rename()` mutator of the
...
[`Task`](https://mlr3.mlr-org.com/reference/Task.html) with the old
column names changed to the new ones.
...
- `ignore_missing` :: `logical(1)`  
  ...
  [`Task`](https://mlr3.mlr-org.com/reference/Task.html). If this is
  `FALSE`, then names found in `renaming` not found in the
  [`Task`](https://mlr3.mlr-org.com/reference/Task.html) cause an error.
