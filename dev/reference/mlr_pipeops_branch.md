...
[`Graph`](https://mlr3pipelines.mlr-org.com/dev/reference/Graph.md). At
any time, only one of these paths will be taken for execution. At the
end of the different paths, the
...
returns the
[`NO_OP`](https://mlr3pipelines.mlr-org.com/dev/reference/NO_OP.md)
object on its output channel. The
[`PipeOp`](https://mlr3pipelines.mlr-org.com/dev/reference/PipeOp.md)
handles each
[`NO_OP`](https://mlr3pipelines.mlr-org.com/dev/reference/NO_OP.md)
input by automatically returning a
[`NO_OP`](https://mlr3pipelines.mlr-org.com/dev/reference/NO_OP.md)
output without calling `private$.train()` or `private$.predict()`, until
[`PipeOpUnbranch`](https://mlr3pipelines.mlr-org.com/dev/reference/mlr_pipeops_unbranch.md)
is reached.
[`PipeOpUnbranch`](https://mlr3pipelines.mlr-org.com/dev/reference/mlr_pipeops_unbranch.md)
will then take multiple inputs, all except one of which must be a
[`NO_OP`](https://mlr3pipelines.mlr-org.com/dev/reference/NO_OP.md), and
forward the only
non-[`NO_OP`](https://mlr3pipelines.mlr-org.com/dev/reference/NO_OP.md)
