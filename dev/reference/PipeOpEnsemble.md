...
that aggregate predictions. Implements the `private$.train()` and
...
[`PipeOp`](https://mlr3pipelines.mlr-org.com/dev/reference/PipeOp.md)s
to perform (possibly weighted) prediction averaging. See e.g.
[`PipeOpClassifAvg`](https://mlr3pipelines.mlr-org.com/dev/reference/mlr_pipeops_classifavg.md)
and
[`PipeOpRegrAvg`](https://mlr3pipelines.mlr-org.com/dev/reference/mlr_pipeops_regravg.md)
...
[`PipeOpLearner`](https://mlr3pipelines.mlr-org.com/dev/reference/mlr_pipeops_learner.md).
See
[`LearnerClassifAvg`](https://mlr3pipelines.mlr-org.com/dev/reference/mlr_learners_avg.md)
and
[`LearnerRegrAvg`](https://mlr3pipelines.mlr-org.com/dev/reference/mlr_learners_avg.md)
for examples.
...
[`PipeOp`](https://mlr3pipelines.mlr-org.com/dev/reference/PipeOp.md) as
well as:
