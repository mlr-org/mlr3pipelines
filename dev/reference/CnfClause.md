...
[`CnfAtom`](https://mlr3pipelines.mlr-org.com/dev/reference/CnfAtom.md)s
or other `CnfClause` objects.
...
- atoms:
  ...
  A list of
  [`CnfAtom`](https://mlr3pipelines.mlr-org.com/dev/reference/CnfAtom.md)
  or other `CnfClause` objects. The clause represents the disjunction of
  these atoms.
