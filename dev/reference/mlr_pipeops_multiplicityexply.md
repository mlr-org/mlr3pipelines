...
by turning the input
[`Multiplicity`](https://mlr3pipelines.mlr-org.com/dev/reference/Multiplicity.md)
into multiple outputs.

This
[`PipeOp`](https://mlr3pipelines.mlr-org.com/dev/reference/PipeOp.md)
has multiple output channels; the members of the input
[`Multiplicity`](https://mlr3pipelines.mlr-org.com/dev/reference/Multiplicity.md)
are forwarded each along a single edge. Therefore, only multiplicities
with exactly as many members as `outnum` are accepted.
...
`PipeOpMultiplicityExply` has a single input channel named `"input"`,
collecting a
[`Multiplicity`](https://mlr3pipelines.mlr-org.com/dev/reference/Multiplicity.md)
of type any (`"[*]"`) both during training and prediction.

`PipeOpMultiplicityExply` has multiple output channels depending on the
`outnum` construction argument, named `"output1"`, `"output2"` returning
the elements of the unclassed input
[`Multiplicity`](https://mlr3pipelines.mlr-org.com/dev/reference/Multiplicity.md).
