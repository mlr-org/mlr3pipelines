...
Creates a
[`Graph`](https://mlr3pipelines.mlr-org.com/dev/reference/Graph.md) from
...
- .key:
  ...
  `[character(1)]`  
  The key of the
  [`Graph`](https://mlr3pipelines.mlr-org.com/dev/reference/Graph.md) in
  [`mlr_graphs`](https://mlr3pipelines.mlr-org.com/dev/reference/mlr_graphs.md).
...
- .keys:
  ...
  [`pos()`](https://mlr3pipelines.mlr-org.com/dev/reference/po.md) it
  will not set any `$id` slots.
