...
[`Task`](https://mlr3.mlr-org.com/reference/Task.html) depending on a
[`Selector`](https://mlr3pipelines.mlr-org.com/dev/reference/Selector.md)
function: The `selector` parameter gives the features to keep. See
[`Selector`](https://mlr3pipelines.mlr-org.com/dev/reference/Selector.md)
for selectors that are provided and how to write custom
[`Selector`](https://mlr3pipelines.mlr-org.com/dev/reference/Selector.md)s.
...
removed that were not selected by the
[`Selector`](https://mlr3pipelines.mlr-org.com/dev/reference/Selector.md)/`function`
in `selector`.
...
- `selection` :: `character`  
  ...
  [`Task`](https://mlr3.mlr-org.com/reference/Task.html). Initialized to
...
- `selector` :: `function` \|
  [`Selector`](https://mlr3pipelines.mlr-org.com/dev/reference/Selector.md)  
  [`Selector`](https://mlr3pipelines.mlr-org.com/dev/reference/Selector.md)
  function, takes a `Task` as argument and returns a `character` of
  features to keep.  
  See
  [`Selector`](https://mlr3pipelines.mlr-org.com/dev/reference/Selector.md)
  for example functions. Defaults to
  [`selector_all()`](https://mlr3pipelines.mlr-org.com/dev/reference/Selector.md).
...
pos$train(list(task))[[1]]$feature_names
#>  [1] "age"     "b"       "crim"    "dis"     "indus"   "lat"     "lon"    
#>  [8] "lstat"   "nox"     "ptratio" "rad"     "rm"      "tax"     "tract"  
#> [15] "zn"     
