...
simplify_cnf = function(entries, universe) {
  ...
  register_unit = function(unit_idx) {
    watch_helper(parent.env(environment()), environment(), "register_unit")
    on.exit(watch_helper(parent.env(environment()), environment(), "register_unit", TRUE, returnValue()), add = TRUE)
  ...
  apply_domain_restriction = function(clause_idx, symbol, restringent, is_unit_propagation) {
    watch_helper(parent.env(environment()), environment(), "apply_domain_restriction")
    on.exit(watch_helper(parent.env(environment()), environment(), "apply_domain_restriction", TRUE, returnValue()), add = TRUE)
  ...
  eliminate_symbol_from_clause = function(clause_idx, symbol) {
    watch_helper(parent.env(environment()), environment(), "eliminate_symbol_from_clause")
    on.exit(watch_helper(parent.env(environment()), environment(), "eliminate_symbol_from_clause", TRUE, returnValue()), add = TRUE)
    clause = entries[[clause_idx]]
    clause[[symbol]] = NULL
  ...
  on_updated_subset_relations = function(meta_idx, meta_idx_other, second_order_only) {
    watch_helper(parent.env(environment()), environment(), "on_updated_subset_relations")
    on.exit(watch_helper(parent.env(environment()), environment(), "on_updated_subset_relations", TRUE, returnValue()), add = TRUE)
  ...
  on_update_range = function(meta_idx, symbol) {
    watch_helper(parent.env(environment()), environment(), "on_update_range")
    on.exit(watch_helper(parent.env(environment()), environment(), "on_update_range", TRUE, returnValue()), add = TRUE)
  ...
  handle_sse_2nd_order_oneend = function(meta_idx, meta_idx_target, symbol) {
    watch_helper(parent.env(environment()), environment(), "handle_sse_2nd_order_oneend")
    on.exit(watch_helper(parent.env(environment()), environment(), "handle_sse_2nd_order_oneend", TRUE, returnValue()), add = TRUE)
  ...
  handle_sse_2nd_order_twoend = function(meta_idx, meta_idx_target, symbol) {
    watch_helper(parent.env(environment()), environment(), "handle_sse_2nd_order_twoend")
    on.exit(watch_helper(parent.env(environment()), environment(), "handle_sse_2nd_order_twoend", TRUE, returnValue()), add = TRUE)
    clause_idx = available[[meta_idx]]
  ...
  try_sse_2nd_order = function(meta_idx_oneend, meta_idx_twoends, meta_idx_target, symbol_intersect, symbol_target) {
    watch_helper(parent.env(environment()), environment(), "try_sse_2nd_order")
    on.exit(watch_helper(parent.env(environment()), environment(), "try_sse_2nd_order", TRUE, returnValue()), add = TRUE)
  ...
  eliminate_clause_update_sr = function(clause_idx) {
    watch_helper(parent.env(environment()), environment(), "eliminate_clause_update_sr")
    on.exit(watch_helper(parent.env(environment()), environment(), "eliminate_clause_update_sr", TRUE, returnValue()), add = TRUE)
