...
This vignette showcases how the `mlr3pipelines` package can be extended to include custom `r ref("PipeOp")`s.
...
`mlr3pipelines` uses the [`r ref_pkg("paradox")`](https://paradox.mlr-org.com) package to define parameter spaces for `r ref("PipeOp")`s.
