...
We will consider scaling the data, transforming it using PCA, or not transforming the data at all (using `PipeOpNOP`).
```r
op1 = PipeOpScale$new()
op2 = PipeOpPCA$new()
op3 = PipeOpNOP$new()
...
Additionally, we use a `PipeOpNOP` in parallel to
...
```{r, eval = FALSE}
  ...
  # Union them with a PipeOpNOP to keep original features
  level_0 = gunion(list(lrn_0, lrn_1,lrn_2, PipeOpNOP$new(id = "NULL1")))
