...
PipeOpOVRSplit = R6Class("PipeOpOVRSplit",
  ...
  private = list(
    ...
    .predict = function(inputs) {
      list(as.Multiplicity(private$.splittask(inputs[[1L]], self$state$levels)))
    },
    .splittask = function(task, levels) {
      ...
      sapply(levels, function(l) {
        ...
        truthcol[[1L]] = factor(ifelse(truthcol[[1L]] == l, l, rest), levels = c(l, rest))
...
PipeOpOVRUnite = R6Class("PipeOpOVRUnite",
  ...
  private = list(
    .predict = function(inputs) {
      ...
      probmat = sweep(probmat, 2L, weights, "*")
