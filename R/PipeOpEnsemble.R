...
#'
#' @description
#' Parent class for [`PipeOp`]s that aggregate predictions. Implements the `$.train()` and `$.predict()` methods necessary
...
#'   called by `$.predict()` with cleaned and sanity-checked values: `inputs` are guaranteed to fit together,
