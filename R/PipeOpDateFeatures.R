  ...
  public = list(
    initialize = function(id = "datefeatures", param_vals = list()) {
      ps = ParamSet$new(params = list(
        ...
        ParamLgl$new("keep_date_var", tags = c("train", "required")),
        ParamLgl$new("cyclic", tags = c("train", "required")),
        ParamLgl$new("year", tags = c("train", "required")),
        ParamLgl$new("month", tags = c("train", "required")),
        ParamLgl$new("week_of_year", tags = c("train", "required")),
        ParamLgl$new("day_of_year", tags = c("train", "required")),
        ParamLgl$new("day_of_month", tags = c("train", "required")),
        ParamLgl$new("day_of_week", tags = c("train", "required")),
        ParamLgl$new("hour", tags = c("train", "required")),
        ParamLgl$new("minute", tags = c("train", "required")),
        ParamLgl$new("second", tags = c("train", "required")),
        ParamLgl$new("is_day", tags = c("train", "required"))
      ))
