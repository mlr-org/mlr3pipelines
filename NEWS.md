...
* feat: Added new hyperparameter `weight_type` to `PipeOpClassWeights` to allow specification which type of weight column to add  (`weights_learner`, `weights_measure`). 
