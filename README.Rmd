...
<!-- badges: start -->
[![R CMD Check via {tic}](https://github.com/mlr-org/mlr3pipelines/workflows/R%20CMD%20Check%20via%20{tic}/badge.svg?branch=master)](https://github.com/mlr-org/mlr3pipelines/actions)
...
* [Comparison](https://mlr3pipelines.mlr-org.com/articles/comparison_mlr3pipelines_mlr_sklearn.html) of `mlr3pipelines` with other packages (not yet authoritative)
* [Writing Custom `PipeOp`s](https://mlr3book.mlr-org.com/extending-mlr3pipelines.html) to extend and build on top of `mlr3pipelines`
